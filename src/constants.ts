...
export enum ChatModels {
  ...
  OPENROUTER_GLM_5_1 = "z-ai/glm-5.1",
  OPENROUTER_GLM_5_1_ONLINE = "z-ai/glm-5.1:online",
  OPENROUTER_DEEPSEEK_R1 = "deepseek/deepseek-r1",
  OPENROUTER_GLM_4_7_FLASH = "z-ai/glm-4.7-flash",
  OPENROUTER_GLM_4_7_FLASH_ONLINE = "z-ai/glm-4.7-flash:online",
...
export const BUILTIN_CHAT_MODELS: CustomModel[] = [
  {
    name: ChatModels.OPENROUTER_GLM_5_1,
  ...
  {
    name: ChatModels.OPENROUTER_GLM_5_1_ONLINE,
    provider: ChatModelProviders.OPENROUTERAI,
    enabled: true,
    isBuiltIn: true,
    projectEnabled: true,
  ...
  {
    name: ChatModels.OPENROUTER_DEEPSEEK_R1,
    provider: ChatModelProviders.OPENROUTERAI,
    enabled: true,
    isBuiltIn: true,
    projectEnabled: true,
  ...
  {
    name: ChatModels.OPENROUTER_GLM_4_7_FLASH,
    provider: ChatModelProviders.OPENROUTERAI,
    enabled: true,
    isBuiltIn: true,
    core: false,
  ...
  {
    name: ChatModels.OPENROUTER_GLM_4_7_FLASH_ONLINE,
    provider: ChatModelProviders.OPENROUTERAI,
    enabled: true,
    isBuiltIn: true,
    core: false,
...
export const ProviderInfo: Record<Provider, ProviderMetadata> = {
  [ChatModelProviders.OPENROUTERAI]: {
    ...
    testModel: ChatModels.OPENROUTER_GLM_5_1,
  },
...
export const DEFAULT_SETTINGS: CopilotSettings = {
  ...
  defaultChainType: "llm_chain" as ChainType,
  defaultModelKey: ChatModels.OPENROUTER_GLM_5_1 + "|" + ChatModelProviders.OPENROUTERAI,
  embeddingModelKey:
